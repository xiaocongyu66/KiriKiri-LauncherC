...
// Auto-mount all sibling .xp3 archives in the same directory as the startup
// archive (TVPProjectDir). Required by commercial KAG VNs that ship with
// multiple xp3 archives (data/bgimage/bgm/scn/voice/...).
...
void TVPBoostAutoMountPaths() {
    ...
    spdlog::info("TVPBoostAutoMountPaths: re-ordered {} paths in auto path list",
