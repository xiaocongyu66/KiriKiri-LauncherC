...
// ZIPArchive.cpp carries a local unzip implementation. Include only minizip's
// I/O callback definitions and define the small public unzip API pieces used
...
typedef struct unz_global_info64_s {
    ZPOS64_T number_entry; /* total number of entries in the central dir */
