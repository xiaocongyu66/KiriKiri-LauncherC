...
namespace motion::detail {
    namespace {
            ...
            EM_ASM(
                {
                    try {
                        if(typeof window == = 'undefined')
                            return;
                        if(!window.__krkr2MotionTrace)
                            window.__krkr2MotionTrace = [];
                        window.__krkr2MotionTrace.push(
        ...
        void writeJsonString(std::ostringstream &out,
        ...
        void appendNodeJson(std::ostringstream &out, const MotionNode &node,
                            int flatIndex) {
            ...
            // Frida oracle reads node+52 and names it blendMode; locally this
            // is the persistent stencilType field, not accumulated.blendMode.
